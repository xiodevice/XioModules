...
typedef enum
{
    ...
    MODULE_NAME_MDI8_PCF8574 = 11081,   // Модуль MDI-8 (чип PCF8574 (1)), универсальные дискретные входы
    MODULE_NAME_MDI16_PCF8575 = 12161,  // Модуль MDI-16 (чип PCF8575 (2))
    MODULE_NAME_MDI8_PCA9554 = 13081,   // Модуль MDI-8 (чип PCA9554 (3)), универсальные дискретные входы
    MODULE_NAME_MDI16_PCA9535 = 14261,  // Модуль MDI-16 (чип PCA9535 (4))
    ...
    MODULE_NAME_MDO8R1_PCA9554 = 23081, // Модуль MDO-8R1 (чип PCA9554), однопоз. реле
    MODULE_NAME_MDO6R2_PCA9554 = 23062, // Модуль MDO-6R2 (чип PCA9554), двупоз. реле
    MODULE_NAME_MDO6R3_PCA9554 = 23063, // Модуль MDO-6R3 (чип PCA9554), разнотипные реле
    MODULE_NAME_MDO8T_PCA9554 = 23085,  // Модуль MDO-8T (чип PCA9554), транзистор
    //MODULE_NAME_MDO10R3_PCA9535 = 24203,// Модуль MDO-10R3 (чип PCA9535), разнотипные реле
